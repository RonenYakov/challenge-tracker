...
- Auth: Supabase Auth (email magic link) issues an ES256 JWT; the server verifies it
  against the project JWKS with `jose`. The server never sees a password or a JWT secret.
